...
if (isset($_POST['cetak'])) {
    ...
    $stmt = $conn->prepare("SELECT MONTH(tanggal_daftar) AS bulan, COUNT(*) AS jumlah 
                            FROM psb 
                            WHERE YEAR(tanggal_daftar) = ? 
                            GROUP BY MONTH(tanggal_daftar)");
    $stmt->bind_param("s", $tahun);
    ...
    $pdf->SetFont('Arial', 'B', 13);
    $pdf->Cell(190, 8, "LAPORAN PENDAFTARAN PSB", 0, 1, 'C');
    $pdf->SetFont('Arial', '', 10);
    ...
    $pdf->Cell(80, 8, 'Jumlah Pendaftaran', 1, 1, 'C');
    ...
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(110, 8, 'Total Pelanggan Baru Yang Mendaftar', 1, 0, 'C');
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Jumlah Pelanggan Yang Mendaftar per Bulan - Tahun
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center mb-0">
                                    ...
                                    ?>
                                        <tr class="bg-light">
                                            <th colspan="2">Total Pelanggan Yang Mendaftar Tahun <?= htmlspecialchars($tahun) ?></th>
