...
$query = "SELECT MONTH(tanggal_melapor) AS bulan, COUNT(*) AS jumlah 
          FROM perbaikan 
          WHERE YEAR(tanggal_melapor) = ? 
...
$totalPerbaikan = array_sum($data_bulanan);
...
if (isset($_POST['cetak'])) {
    ...
    if (file_exists($logoPath)) {
        ...
        $scale = min(25 / $h, 50 / $w);
        $pdf->Image($logoPath, 10, 10, $w * $scale, $h * $scale);
    }
    ...
    $pdf->SetFont('Arial', 'B', 13);
    $pdf->Cell(190, 8, "LAPORAN JUMLAH PERBAIKAN PELANGGAN", 0, 1, 'C');
    $pdf->SetFont('Arial', '', 10);
    ...
    $pdf->Cell(80, 8, 'Jumlah Perbaikan', 1, 1, 'C');
    ...
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(110, 8, 'Total Perbaikan Yang Masuk', 1, 0, 'C');
    $pdf->Cell(80, 8, $totalPerbaikan, 1, 1, 'C');
        ...
        <div class="content-wrapper bg-white">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Laporan Frequensi Perbaikan</h1>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Jumlah Perbaikan Yang Masuk per Bulan - Tahun
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center mb-0">
                                    ...
                                    ?>
                                        <tr class="bg-light">
                                            <th colspan="2">Total Perbaikan Yang Masuk Tahun <?= htmlspecialchars($tahun) ?></th>
                                            <th><?= $totalPerbaikan ?></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
